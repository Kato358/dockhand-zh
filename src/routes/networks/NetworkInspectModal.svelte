			...
			{:else if networkData}
				...
				<div class="space-y-3">
					...
					<div class="grid grid-cols-2 gap-3 text-sm">
						...
						<div>
							<p class="text-muted-foreground">内部</p>
								...
								<div class="space-y-2">
									...
									{#each networkData.IPAM.Config as config}
										<div class="p-2 bg-muted rounded text-sm space-y-1">
											...
											{#if config.IPRange}
												<div class="flex justify-between">
													<span class="text-muted-foreground">IP地址范围：</span>
				...
				{:else}
					<div class="text-sm text-muted-foreground text-center py-4">此网络未连接任何容器</div>
				{/if}
