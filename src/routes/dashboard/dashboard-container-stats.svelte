...
{:else if showSkeleton}
	...
	<div class="grid grid-cols-7 gap-1 min-h-5">
		...
		<div class="flex items-center gap-1">
			<span class="text-xs text-muted-foreground/50">总计</span>
			<div class="skeleton w-4 h-4 rounded"></div>
		</div>
	</div>
{:else if compact}
	...
	<div class="flex items-center gap-1.5 shrink-0">
		...
		<div class="flex items-center gap-0.5" title="正在重启">
		...
		<div class="flex items-center gap-0.5" title="不良">
...
{:else}
	...
	<div class="grid grid-cols-7 gap-1 min-h-5">
		...
		<div class="flex items-center gap-1" title="不健康的容器">
		...
		<div class="flex items-center gap-1" title="总容器">
